...
// grid of that category's sub-platforms. Every card here links internally to
// /<basePath>/<id>, which embeds the real site in an iframe - so the actual
// destination URL never appears in the browser's address bar.
